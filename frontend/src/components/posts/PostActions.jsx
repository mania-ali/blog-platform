export default function PostActions() {
  return (
    <div className="border-t border-gray-100 px-2 py-1 flex items-center justify-between text-gray-600 text-sm font-medium">
      <button className="flex-1 flex items-center justify-center gap-2 py-2 hover:bg-gray-100 rounded-lg transition text-gray-600 hover:text-blue-600">
